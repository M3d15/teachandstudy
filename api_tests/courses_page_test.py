...
def test_courses_search(base_api_url, access_token):
    ...
    first_course_name = json_courses_list_data['results'][0]['name']
    ...
    if len(json_course_search_data['results']) > 0:
        assert json_course_search_data['results'][0]['name'] == first_course_name
